...
$stmt = $conn->prepare("SELECT nome, descricao, preco, categoria FROM produtos WHERE id = ?");
$idInt = (int)$id;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($nome === '' || $preco <= 0) {
        ...
        $stmt->bind_param("ssdsi", $nome, $descricao, $preco, $categoria, $idInt);
        ...
        <form method="post">
            ...
            <p>
                <label>Preço (ex: 49.90):<br>
                    <input type="number" step="0.01" name="preco" value="<?= htmlspecialchars($preco); ?>" required>
                </label>
            </p>
            <p>
                <label>Categoria:<br>
